...
export function CustomerForm({ customer }: CustomerFormProps) {
  ...
  const { values, isSaving, update, save } = useCustomerForm({
    customer,
            ...
            <div className='grid gap-5 lg:grid-cols-[160px_minmax(0,1fr)]'>
              ...
              <div className='space-y-2'>
                ...
                <Select
                  value={values.status}
                  onValueChange={(value) =>
                    update('status', (value ?? 'ACTIVE') as CustomerStatus)
                  }
                >
          ...
          <CardContent className='space-y-4 p-4 sm:p-5'>
            ...
            <div className='border-t pt-4'>
              <p className='text-xs leading-5 text-muted-foreground'>
                Customer order history and sales activity are available from the
